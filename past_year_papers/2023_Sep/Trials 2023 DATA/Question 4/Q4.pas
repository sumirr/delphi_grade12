...
begin
  ...
  begin
    ...
    for col := 1 to 5 do
    begin
      sRow := sRow + arrResult[row, col] + ' ';
    end;
    redDisplay.Lines.Add(sRow);
  end;
...
var
  ...
  sline, steam1, steam2, sround, sscore1, sscore2, spoint1, spoint2: string;
begin
  // Question 4.1
  ...
  begin
    ...
    // score 2
    sscore2 := copy(sline, ipos + 1, 1);
    redDisplay.Lines.Add(sscore2);

    if sscore1 > sscore2 then
    begin
      spoint1 := '3';
      spoint2 := '0';
    end

    else if sscore1 < sscore2 then
    begin
      spoint1 := '0';
      spoint2 := '3';
    end;
    ...
    // left to right
    for row := 1 to 8 do
    if steam1= arrParticipants[row] then
    begin
      if sscore1>sscore2 then
      arrResult[row,strtoint(sround)]  := '3';
    end;
